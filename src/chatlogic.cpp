        ...
        if (idToken != tokens.end()) {
          ...
          if (type->second == "EDGE") {
            ...
            if (parentToken != tokens.end() && childToken != tokens.end()) {
              ...
              edge->SetChildNode((*childNodeItr).get());
              edge->SetParentNode((*parentNodeItr).get());
              ...
              (*childNodeItr)->AddEdgeToParentNode(edge.get());
              (*parentNodeItr)->AddEdgeToChildNode(std::move(edge));
            }
